...
target ('main_anp_v0_3': "Load the Grails interactive shell") {
	depends( configureProxy, packageApp, classpath, loadApp, configureApp )

	println 'Called ExecuteDatabaseScriptsV0_3.groovy'	
	
	def data_files = ['data.sql']
	
	def schema_files = ['schema.sql']
	
	def version_folder = 'anp_v0_3'
...
setDefaultTarget(main_anp_v0_3)