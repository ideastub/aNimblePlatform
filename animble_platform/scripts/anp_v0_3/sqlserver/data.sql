...
DECLARE @ref_id INT
SELECT @ref_id=ref_id  FROM reference where reference_group = 'artifact' and display_code ='PRODUCTBACKLOG';
...
SELECT @ref_id=ref_id FROM reference where reference_group = 'artifact' and display_code ='TASK';
