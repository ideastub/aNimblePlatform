...
SET @ref_id = 0;
SELECT ref_id into @ref_id FROM reference where reference_group = 'artifact' and display_code ='DESIGN' limit 1;
...
SELECT ref_id into @ref_id FROM reference where reference_group = 'artifact' and display_code ='FEATURE' limit 1;

INSERT INTO application_control
   (application_control_id,display_sequence,control_text, control_description, visible_ind,init_script,unit_height,control_ref_id)
VALUES (10273,0,'Feature Artifact','Feature Artifact', 1, 'FeatureArtifact.section_title', 30,@ref_id);

SELECT ref_id into @ref_id FROM reference where reference_group = 'artifact' and display_code ='IMPLEMENTATION' limit 1;

INSERT INTO application_control
   (application_control_id,display_sequence,control_text, control_description, visible_ind,init_script,unit_height,control_ref_id)
VALUES (10274,0,'Implementation Artifact','Implementation Artifact', 1, 'ImplementationArtifact.section_title', 30,@ref_id);

SELECT ref_id into @ref_id FROM reference where reference_group = 'artifact' and display_code ='REQUIREMENT' limit 1;

INSERT INTO application_control
   (application_control_id,display_sequence,control_text, control_description, visible_ind,init_script,unit_height,control_ref_id)
VALUES (10275,0,'Requirement Artifact','Requirement Artifact', 1, 'RequirementArtifact.section_title', 30,@ref_id);

SELECT ref_id into @ref_id FROM reference where reference_group = 'artifact' and display_code ='TESTCASE' limit 1;
