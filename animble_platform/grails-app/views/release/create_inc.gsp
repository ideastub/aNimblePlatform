<%@ page import="com.nimble.domain.release.Release;com.nimble.utils.view.ViewHelper;com.nimble.domain.reference.*;com.nimble.utils.view.ViewHelper; com.nimble.utils.domain.ReferenceHelper;" %>
...
<%
request.viewHelper.setSectionTitle('Add Release')
...
<% println(g.include(view:'/release/navigation.gsp', params:params)) %>
            ...
            <g:form action="save" method="post" name="myform" >
                <g:hiddenField name="project.id" value="${request.viewHelper.getProjectId()}" />
