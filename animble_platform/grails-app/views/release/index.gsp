...
<div dojoType="dijit.layout.SplitContainer"
        ...
        <div dojoType="dijit.layout.ContentPane" sizeMin="30" sizeShare="20" preload="true" 
            id="ReleaseTree" dojoType="dijit.layout.ContentPane" style="background-color: #FFFFFF;width:25%;height:100%;border:0px;"
			preventCache="true" >
			<% println(g.include(action:'menu',controller:'release',id:request.viewHelper.getProjectId())) %>
        </div>
