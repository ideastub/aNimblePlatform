<%@ page import="com.nimble.domain.release.Sprint;com.nimble.utils.view.ViewHelper;com.nimble.domain.reference.*;com.nimble.utils.view.ViewHelper; com.nimble.utils.domain.ReferenceHelper;" %>
...
<%
request.viewHelper.setSectionTitle('Add Sprint')
...
<% println(g.include(view:'/sprint/navigation.gsp', params:params)) %>
            ...
            <g:form action="save" method="post" name="myform" >
                <g:hiddenField name="agileProject.id" value="${request.viewHelper.getProjectId()}" />
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="sprintStartDate"><g:message code="sprint.sprintStartDate.label" default="Sprint Start Date" /></label>
                                </td>
