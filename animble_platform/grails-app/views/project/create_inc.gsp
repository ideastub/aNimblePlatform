<%@ page import="com.nimble.domain.project.Project;com.nimble.utils.view.ViewHelper;com.nimble.domain.reference.*;com.nimble.utils.view.ViewHelper; com.nimble.utils.domain.ReferenceHelper;" %>
...
<%
request.viewHelper.setSectionTitle('Add Project')
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="projectStartDate"><g:message code="project.projectStartDate.label" default="Project Start Date" /></label>
                                </td>
