...
<%
request.viewHelper.setSectionTitle('Update Report')
...
<% println(g.include(view:'/report/navigation.gsp', params:params)) %>
            ...
            <g:form method="post" name="myform" id="${reportInstance?.id}" action="update">
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: reportInstance, field: 'report_location_ref', 'errors')}">
                                    <g:select name="report_location_ref.id" from="${com.nimble.domain.report.ReportLocationReference.list()}" optionKey="id" value="${reportInstance?.report_location_ref?.id}"  />
                                </td>
                            </tr>
\                        
                            <tr class="prop">
