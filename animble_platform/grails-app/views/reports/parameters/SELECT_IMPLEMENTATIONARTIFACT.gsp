...
<g:select name="${params.reportParamName}" id="${params.reportParamName}" from="${ArtifactQuery.getArtifactsSelectList(viewHelper.getProjectId(),'ImplementationArtifact')}" optionKey="id"/>