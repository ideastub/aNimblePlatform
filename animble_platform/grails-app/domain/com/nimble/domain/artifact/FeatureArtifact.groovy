...
class FeatureArtifact extends Artifact {

  FeatureVersionReference version_ref
  FeatureVersionReference planned_version_ref
  FeaturePriorityReference priority_ref
  FeatureStatusReference status_ref
  ...
  static mapping = {
      ...
      discriminator value: "FeatureArtifact"     
