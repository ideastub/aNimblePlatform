...
class RequirementArtifact extends Artifact {

  RequirementVersionReference version_ref
  RequirementVersionReference planned_version_ref
  RequirementPriorityReference priority_ref
  RequirementStatusReference status_ref
  ...
  static mapping = {
      ...
      discriminator value: "RequirementArtifact"     
