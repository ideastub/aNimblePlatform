...
class ProductBacklogArtifact extends Artifact {

  ProductBacklogVersionReference version_ref
  ProductBacklogVersionReference planned_version_ref
  ProductBacklogPriorityReference priority_ref
  ProductBacklogStatusReference status_ref
  ...
  static mapping = {
      ...
      discriminator value: "ProductBacklogArtifact"     

  }

  static fetchMode = [sprint:'eager', version_ref:'eager', planned_version_ref:'eager', priority_ref:'eager', status_ref:'eager']
