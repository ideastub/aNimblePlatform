...
class TaskArtifact extends Artifact {

  TaskVersionReference version_ref
  TaskVersionReference planned_version_ref
  TaskPriorityReference priority_ref
  TaskStatusReference status_ref
  ...
  static mapping = {
      ...
      discriminator value: "TaskArtifact"     
