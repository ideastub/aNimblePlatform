...
class ImplementationArtifact extends Artifact {

  ImplementationVersionReference version_ref
  ImplementationVersionReference planned_version_ref
  ImplementationPriorityReference priority_ref
  ImplementationStatusReference status_ref
  ...
  static mapping = {
      ...
      discriminator value: "ImplementationArtifact"     
